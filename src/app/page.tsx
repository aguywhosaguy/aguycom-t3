    ...
    <main className="px-20 py-30 my-20 mx-auto max-w-6xl">
      <div className="space-y-5">
        ...
        <div className="space-y-3">
          ...
          <p>My main goal throughout my various coding projects is to make things easier (which is the point of programming), partically in the video gaming space. While not every project I&#39;ve made pertains to gaming, making mods and programs for games is what got me into programming in the first place.</p>
          <p></p>
        </div>
